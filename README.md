...
A repository dedicated to hosting expert-curated datasets of public domain reconstructions of the Evangelion/Evangelium of Marcion.
...
The files in this repository all adopt the cts_urn author identifer prefix for Marcion of Sinope (tlg2958) and effectively mint a new cts_urn document id for the Evangelion of Marcion (tlg002). The number after "grc" corresponds to its edition, following the historical order of the respective publications.
...
If you make use of any of this repository data in publications or code, please cite the corresponding peer-reviewed, published journal articles, and/or my LODLIB, an open science book format allowing for open, ongoing peer-review and agile improvement.
